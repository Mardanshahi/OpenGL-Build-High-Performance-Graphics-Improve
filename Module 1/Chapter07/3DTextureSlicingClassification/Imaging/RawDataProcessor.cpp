...
bool CRawDataProcessor::LoadFile(std::string lpDataFile_i, unsigned int nWidth_i, unsigned int nHeight_i, unsigned int nSlices_i )
{
    std::ifstream infile(lpDataFile_i.c_str(), std::ios_base::binary);
